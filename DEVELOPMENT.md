...
├── telegram-voice-phones.jpg # Иллюстрация с телефонами для секции "Голос"
...
- **Контент:** `index.html` (HTML контент с типографикой)
- **Стили:** `index.html` (CSS в `<style>`)
- **Фото Софи:** `sofia-photo.jpg` (главное фото ассистента)
- **Иллюстрация голосового ввода:** `telegram-voice-phones.jpg` (секция "Голос")
...
**Последнее обновление:** 3 октября 2025 - добавлена иллюстрация телефонов в секцию "Голос"
